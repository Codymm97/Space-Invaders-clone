...
def getNumAliens(ai_settings,alien_width):
...
def create_fleet(ai_settings,screen,ship,aliens):
	alien = Aliens(ai_settings,screen)
	number_aliens_x = getNumAliens(ai_settings,alien.rect.width)
	number_rows = get_num_row(ai_settings, ship.rect.height, alien.rect.height)
...
def update_screen(ai_settings, screen, stats, sb, ship, aliens, bullets, play_button):
		#filling screen with this color
